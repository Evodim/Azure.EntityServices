...
namespace Azure.EntityServices.Table.Common.Fakes
{
    public static class Fakers
    {
        ...
        public static Faker<PersonEntity> CreateFakePerson(string[] accounts = null)
        {
            ...
            .RuleFor(p => p.LocalCreated, f => DateTime.SpecifyKind(f.Date.Between(DateTime.UtcNow.AddYears(-4), DateTime.UtcNow),DateTimeKind.Utc))            
            .RuleFor(p => p.LocalUpdated, f => DateTime.SpecifyKind(f.Date.Between(DateTime.UtcNow.AddYears(-4), DateTime.UtcNow), DateTimeKind.Utc))
